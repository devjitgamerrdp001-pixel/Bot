...
# ---------------- Client Setup (Workers 25 | Boosted Transmissions for 1MB/s+) ----------------
app = Client(
    "termux_bot",
    api_id=API_ID,
    api_hash=API_HASH,
    ...
    workers=25, 
    max_concurrent_transmissions=25, # Boosted for higher parallel data throughput
    sleep_threshold=180, 
    ipv6=False 
)
    ...
    try:
        ...
        async def dl_progress(line):
            ...
            if match and time.time() - last_update > 12: 
                ...
                # Regex for accurate Size Extraction
...
if __name__ == "__main__":
    # Deleting old session_data for a fresh start
